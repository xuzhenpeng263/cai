...
class MoonshotModel(Model):
    ...
    async def get_response(
        ...
        """Get a response from the Moonshot model."""
        # Prepare messages
    ...
    def stream_response(
        ...
        """Stream a response from the Moonshot model."""
        # Prepare messages
        messages = self._prepare_messages(system_instructions, input)
